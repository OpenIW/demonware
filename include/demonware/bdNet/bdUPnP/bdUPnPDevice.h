...
public:
    bdUPnPDevice();
    ~bdUPnPDevice();
    bdBool init(bdArray<bdInetAddr>* localAddrs, const bdByte8* const fetchLocation, const bdInt fetchLen, const bdInetAddr* deviceAddr, const bdUInt16 port, const bdUPnPConfig config);
    void pump();
    void cleanup();
