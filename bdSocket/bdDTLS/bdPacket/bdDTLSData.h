...
public:
    bdDTLSData();
    bdDTLSData(bdUInt16 vtag, bdUInt16 counter);
    ~bdDTLSData();
    virtual bdBool serialize(void* outData, const bdUInt outDataSize, const bdUInt outDataOffset, bdUInt& outDataNewOffset, const bdSequenceNumber& lastSequenceNumber,
    ...
    virtual bdBool deserialize(const void* inData, const bdUInt inDataSize, const bdUInt inDataOffset, bdUInt& inDataNewOffset, const bdSequenceNumber& lastSequenceNumber,
